...
public class MemberDataAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Glide.with(parent.getContext()).load(myUri).signature(new StringSignature(String.valueOf(System.currentTimeMillis()))).into(img_flag);

       // MyAsyncTask mProcessTask = new MyAsyncTask();
        //mProcessTask.execute(myUri.toString());
...
//        }
    ...
    public class MyAsyncTask extends AsyncTask<String, String, String> {
        ...
        @Override
        protected String doInBackground(final String... integers) {
